...
async function main() {
  ...
  const drills = [
    ...
    {
      id: 'stress-timing-1',
      title: 'Photograph — Primary Stress',
      drillType: 'STRESS_TIMING',
      targetText: 'Photograph',
      targetIpa: 'ˈfəʊ t ə ɡ r ɑː f',
      description: 'Hold the stressed syllable /ˈfəʊ/ longer. Reduce the unstressed syllables toward schwa.',
      difficulty: 2,
      phonemeSequence: [
        { phonemeId: 'f', position: 0, startTimeMs: 0, endTimeMs: 280, phoneme: {} },
        { phonemeId: 'ʊ', position: 1, startTimeMs: 280, endTimeMs: 520, phoneme: { f1TargetHz: 440, f2TargetHz: 1020 } },
        { phonemeId: 't', position: 2, startTimeMs: 520, endTimeMs: 720, phoneme: {} },
        { phonemeId: '@', position: 3, startTimeMs: 720, endTimeMs: 900, phoneme: { f1TargetHz: 500, f2TargetHz: 1500 } },
        { phonemeId: 'g', position: 4, startTimeMs: 900, endTimeMs: 1100, phoneme: {} },
        { phonemeId: 'r', position: 5, startTimeMs: 1100, endTimeMs: 1300, phoneme: {} },
        { phonemeId: 'ɑː', position: 6, startTimeMs: 1300, endTimeMs: 1700, phoneme: { f1TargetHz: 750, f2TargetHz: 1100 } },
        { phonemeId: 'f', position: 7, startTimeMs: 1700, endTimeMs: 2000, phoneme: {} },
      ],
    },
    {
      id: 'stress-timing-2',
      title: 'Beautiful — Sentence Stress',
      drillType: 'STRESS_TIMING',
      targetText: 'It is beautiful',
      targetIpa: 'ɪt ɪz ˈbjuː t ɪ f əl',
      description: 'Content words should be longer and clearer than function words. Keep "beautiful" prominent.',
      difficulty: 3,
      phonemeSequence: [
        { phonemeId: 'ɪ', position: 0, startTimeMs: 0, endTimeMs: 160, phoneme: { f1TargetHz: 390, f2TargetHz: 1990 } },
        { phonemeId: 't', position: 1, startTimeMs: 160, endTimeMs: 260, phoneme: {} },
        { phonemeId: 'ɪ', position: 2, startTimeMs: 260, endTimeMs: 420, phoneme: { f1TargetHz: 390, f2TargetHz: 1990 } },
        { phonemeId: 'z', position: 3, startTimeMs: 420, endTimeMs: 560, phoneme: {} },
        { phonemeId: 'b', position: 4, startTimeMs: 560, endTimeMs: 760, phoneme: {} },
        { phonemeId: 'u:', position: 5, startTimeMs: 760, endTimeMs: 1100, phoneme: { f1TargetHz: 300, f2TargetHz: 870 } },
        { phonemeId: 't', position: 6, startTimeMs: 1100, endTimeMs: 1300, phoneme: {} },
        { phonemeId: 'ɪ', position: 7, startTimeMs: 1300, endTimeMs: 1480, phoneme: { f1TargetHz: 390, f2TargetHz: 1990 } },
        { phonemeId: 'f', position: 8, startTimeMs: 1480, endTimeMs: 1680, phoneme: {} },
        { phonemeId: '@', position: 9, startTimeMs: 1680, endTimeMs: 1900, phoneme: { f1TargetHz: 500, f2TargetHz: 1500 } },
        { phonemeId: 'l', position: 10, startTimeMs: 1900, endTimeMs: 2100, phoneme: {} },
      ],
    },
  ];
